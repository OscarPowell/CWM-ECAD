...
set_property -dict [list CONFIG.Component_Name {mybram} CONFIG.Write_Width_A {6} CONFIG.Write_Depth_A {26} CONFIG.Read_Width_A {6} CONFIG.Write_Width_B {6} CONFIG.Read_Width_B {6} CONFIG.Load_Init_File {true} CONFIG.Coe_File {/home/centos/CWM-ECAD/Ex7/Ex7.srcs/sources_1/ip/answers.coe}] [get_ips mybram]
